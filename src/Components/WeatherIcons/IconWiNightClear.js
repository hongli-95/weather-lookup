// icon:wi-night-clear | Weather Icons https://erikflowers.github.io/weather-icons/ | Eric Flowers
import * as React from "react";

function IconWiNightClear(props) {
  return (
    <svg
      viewBox="0 0 30 30"
      fill="currentColor"
...
export default IconWiNightClear;
