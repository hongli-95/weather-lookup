// icon:wi-night-alt-cloudy | Weather Icons https://erikflowers.github.io/weather-icons/ | Eric Flowers
import * as React from "react";

function IconWiNightAltCloudy(props) {
  return (
    <svg
      viewBox="0 0 30 30"
      fill="currentColor"
...
export default IconWiNightAltCloudy;
